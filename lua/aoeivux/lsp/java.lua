...
local maven = require("aoeivux.core.utils.maven")

local function or_default(a, v)
  return require("aoeivux.core.utils").or_default(a, v)
end
...
local vscode = require("aoeivux.core.vscode")
...
M.setup = function()
  local group = vim.api.nvim_create_augroup("aoeivux_jdtls_java", { clear = true })
