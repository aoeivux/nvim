...
-- for neovim 0.8
-- vim.api.nvim_set_hl("CocCustomPopup", { guifg = "#ebdbb2", guibg = "#282828" })
-- -- border
-- vim.api.nvim_set_hl("CocCustomPopupBoder", { guifg = "#5F5F5F", gui = "bold" })
-- -- selected row
-- vim.api.nvim_set_hl("CocMenuSel", { guibg = "#3c3836", gui = "bold" })
-- -- matched_text
-- vim.api.nvim_set_hl("CocSearch", { guifg = "#fabd2f" })
-- AutoCmds
